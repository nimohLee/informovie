                            ...
                            <div className='col-span-2'>
                                {
                                        ...
                                        (
                                            parseInt(movie.rankInten) > 0 ?
                                        <div className='flex items-center'><FontAwesomeIcon icon={icons.arrowUpIcon} className="text-red-500 text-2xl"/><span className='ml-2'>{movie.rankInten}</span></div> :
                                        <div className='flex flex items-center'><FontAwesomeIcon icon={icons.arrowDownIcon} className="text-blue-500 text-2xl"/><span className='ml-2'>{movie.rankInten}</span></div>
                                        )
                                    }
                            </div>
                            </div>
